...
//            connection.setRequestProperty(key, value);
    ...
    public static void main(String[] args) {
        //发送 GET 请求
        String s=HttpRequest.sendGet("http://ebm.elenet.me/services/es/clusters/", "name=xg-pcd-es-srv");
        System.out.println(s);
        JSONObject json = JSONObject.parseObject(s);
        List<Object> array = json.getJSONArray("data");
